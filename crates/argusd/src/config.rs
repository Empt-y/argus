...
mod tests {
    ...
    fn the_shipped_example_config_parses_and_validates() {
        ...
        for id in ["air-quality", "airports", "argo-floats", "fireballs", "cable-landings", "firms", "power-grid", "submarine-cables", "buoys", "buses", "carbon-intensity", "ground-stations", "metars", "meteors", "offshore-platforms", "road-disruptions", "sea-state", "seismographs", "street-crime", "wind-farms", "river-gauges", "storm-overflows", "flights"] {
